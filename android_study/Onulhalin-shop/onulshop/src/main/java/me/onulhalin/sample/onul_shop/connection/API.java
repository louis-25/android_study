...
Call<CallbackProduct> getAllListProduct(
    ...
    @Headers({CACHE, AGENT})
    @GET("services/getStatusCnt")
    Call<CallbackCnt> getStatusCnt(
...
//    );
    ...
    @Headers({CACHE, AGENT, SECURITY})
    @POST("services/updateStatus")
    Call<CallbackOrder> AcceptOrder(
    ...
    @Headers({CACHE, AGENT})
    @GET("services/getProductCnt")
    Call<CallbackCnt> getProductCnt(
            @Query("id") String id
    );


    @Headers({CACHE, AGENT, SECURITY})
    @POST("services/shopuserupdate")
    Call<CallbackJoin> shopuserupdate(
            @Body login login
    );

    @Headers({CACHE, AGENT, SECURITY})
    @POST("services/shopUserCommute")
    Call<CallbackJoin> shopUserCommute(
            @Body login login
    );
