                ...
                switch (item.getItemId()){
                    ...
                    case R.id.nav_settings:
                        startActivity(new Intent(rootView.getContext(), SettingsActivity.class)
                                .putExtra("_id",PreferenceManager.getString(rootView.getContext(),"_id"))
                                .putExtra("IsActive",PreferenceManager.getString(rootView.getContext(),"IsActive"))
                                .putExtra("deviceId",PreferenceManager.getString(rootView.getContext(),"deviceId"))
                                .putExtra("deviceName",PreferenceManager.getString(rootView.getContext(),"deviceName")));
                        Log.d("data6=",PreferenceManager.getString(rootView.getContext(),"_id"));
                        break;
                    default:
                        break;
                }
