...
public class DeviceOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "data1 = "+loginuid);
        Log.d(TAG, "data2 = "+deviceId);
        Log.d(TAG, "data3 = "+deviceName);
        Log.d(TAG, "data4 = "+loginActive);
 ...
 */
        ...
        saveDevOpt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(DeviceOption.this, "설정 변경 완료", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
