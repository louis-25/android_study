...
//    public static String WEB_URL = "http://your-domain.com/project/markeet_panel/";

//    public static String WEB_URL =" http://demo.dream-space.web.id/markeet_panel/";
//    public static String WEB_URL ="http://192.168.1.5/admin_project/";
//    public static String WEB_URL ="http://172.30.1.28/admin_project/";


    // 도메인
//    public static String WEB_URL ="http://192.168.0.23/admin_project/";
    public static String WEB_URL ="http://onul-halin.com/admin/";
//    public static String WEB_URL ="http://192.168.0.10/admin_project/";
